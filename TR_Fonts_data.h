// Türkçe karakterler için veri dosyası
// Linkteki araç kullanılarak yapılmıştır (The data in this file is generated using the tool in following link):
//https://pjrp.github.io/MDParolaFontEditor

#pragma once

 MD_MAX72XX::fontType_t TR[] PROGMEM =
{
	0, 	// 0            - 'Unused'
	0, 	// 1            - 'Unused'
	0, 	// 2            - 'Unused'
